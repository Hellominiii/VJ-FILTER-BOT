...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6615966362').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002132409575') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002132202139')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002147420607')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', LOG_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002175896511')).split()]
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Princess6:Princess66@princess.xgq7smm.mongodb.net/?retryWrites=true&w=majority")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'renoji') # owner username without @

# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/hhjjjvvhhhggg')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/hjjjnnngdss')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'ghhhhhbnnmkl') # Support Chat Link Without https:// or @
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'a37bd0e6190b14ff1c189e54dbaab94fe5a72bbe')
